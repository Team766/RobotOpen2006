...
/*
 * August 18, 2012 Frank Adams
 * Overload RobotOpenClass::begin to accept an IP address other than the default.
 * To avoid touching the original, I just edited a copy of the existing code.
 */
...
static byte ip[]  = { 192, 168, 1, 22 }; // RobotOpen default
// static byte ip[]  = { 10, 7, 66, 122 }; // Team 766 wireless setup
// static byte ip[]  = { 172, 16, 0, 122 }; // Adams home network
